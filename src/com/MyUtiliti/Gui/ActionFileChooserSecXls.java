...
public class ActionFileChooserSecXls {
    public ActionFileChooserSecXls(JButton btnName, JLabel labbleName) {
        ...
        btnName.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (ret == JFileChooser.APPROVE_OPTION){
                    ...
                    try {
                        ReadXlsFileSec secExls = new ReadXlsFileSec(file.getCanonicalPath());
